        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white/90 dark:bg-card/80 backdrop-blur-md text-card-foreground shadow-lg rounded-lg p-6 border border-purple-200 dark:border-white/10">
            ...
            <ul className="list-disc pl-6 mb-6 space-y-3">
              <li className="text-cyan-600 dark:text-cyan-300">Managing emoji submissions</li>
              <li className="text-purple-600 dark:text-purple-300">Reviewing user reports</li>
              <li className="text-pink-600 dark:text-pink-300">Configuring application settings</li>
              <li className="text-blue-600 dark:text-blue-300">Viewing analytics and statistics</li>
            </ul>
